(function() {
  (function(vjs) {
    ...
    Clip = (function() {
      ...
      Clip.duration = function(length, in_seconds) {
        if (length) {
    ...
    comscore = function(id, playlist, keymap_override) {
      ...
      player.comscore = {
        getClips: function() {
          return set_playlist(make_clips(playlist));
        }
      };
      return initialize();
    };
